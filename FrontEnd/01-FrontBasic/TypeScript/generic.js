...
var randomString = getRandomString(["A", "B", "C"]);
console.log("문자열 배열에서 랜덤한 문자 추출하기:", randomString);
var randomNumber = getRandomNumber([1, 2, 3]);
...
var randomElement1 = getRandomElement(["A", "B", "C"]);
console.log("getRandomElement-string:", randomElement1);
var randomElement2 = getRandomElement([1, 2, 3]);
console.log("getRandomElement-number:", randomElement2);
var randomElement3 = getRandomElement([
